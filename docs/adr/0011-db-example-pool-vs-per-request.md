# 0011 - db_example: two connection-scope variants (pool vs per-request)
Status: accepted
Date: 2026-06-01

## Context
The db_example context teaches aiosqlite wiring under Dishka. Two common
...
(`/db-example/pooled/items` and `/db-example/per-request/items`).
