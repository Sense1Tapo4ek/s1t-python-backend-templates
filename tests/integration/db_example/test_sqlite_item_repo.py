...
from db_example.adapters.driven.db.connection import open_connection
from db_example.domain import Item
from db_example.ports.driven.repos import SqliteItemRepo

_DDL = Path("migrations/db_example/001-create-items.sql").read_text()
