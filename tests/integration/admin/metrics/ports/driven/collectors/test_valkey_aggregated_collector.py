...
class TestValkeyAggregatedCollector:
    ...
    async def test_missing_optional_fields_are_skipped(self, redis) -> None:
        """
    ...
    async def test_redis_failure_yields_empty(self, redis) -> None:
        """
